/**
 * very likely resume will be put through ATS
 *      EVEN THROUGH buddies, references, indeed, monster,
 *      etc. Almost always!
 *      It will look through skills, tech tags (and a lot of other miscellaneous)
 *      First person to look through materials most likely not a developer (recruiter, etc)
 *      
 *      What is that first person looking for?
 *          - Where are you coming from?
 *          - Pre-Bloom Tech experience
 *          - What is their story?
 *          - What is the tech prowess to table?
 *          - Sophisticated, impactful re: business
 * 
 *      THEN passed onto more technically savvy person
 * 
 *      SKILLS section:
 *          Which skills to include?
 *          Mention any skills BY NAME with projects
 *          Projects should be TECHNICALLY DETAILED
 *          If not NAMED in project, they'll assume only covered in e.g. free online course, but w/o practical experience
 *          BUT still feel free to list those other skills
 *          Named skills carry much more WEIGHT
 * 
 *          "my" does not go on resumes
 * 
 *      In job descriptions, too much focus on OTHERS (supporting, etc), which is too passive. Rather than "supported instruction..." say "led discussion!"
 * 
 *      Focus should be on YOU - when describing a project, for example, "full stack" if project full stack
 * 
 *      be CLEAR in project descriptions
 *      you develop XYZ function--USING WHAT; --TO DO WHAT
 *      being as clear as possible with techs used, user stories, etc.
 * 
 *      Try to pin one more project on GitHub
 * 
 *      Why are you not including Miranda stuff w/ Resume. 
 * 
 *      At least think about!
 * 
 *      LINKED IN:
 *      - swap out bullet points for what's in resume
 *      - add projects
 *      - translator job title, etc
 *      - add any skills listed in resume
 *      - add GitHub as featured link
 * 
 *      TAILOR PROJECTS
 *      React
 *      Redux
